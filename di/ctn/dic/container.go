...
//		- "2": Service(*mysqltxprovider.Impl) ["tx_provider"]
//	unshared: false
//	close: false
//
// ---------------------------------------------
...
//		- "1": Service(*logrus.Entry) ["logger_logrus"]
//		- "2": Service(*mysqltxprovider.Impl) ["tx_provider"]
//		- "3": Service(*mysqlstore.Store) ["persistence_mysql"]
//	unshared: false
//	close: false
//
// ---------------------------------------------
//
// If the object can not be retrieved, it returns an error.
func (c *Container) SafeGetLogicCategory() (*categorylogic.Impl, error) {
	i, err := c.ctn.SafeGet("logic_category")
	if err != nil {
		var eo *categorylogic.Impl
		return eo, err
	}
	o, ok := i.(*categorylogic.Impl)
	if !ok {
		return o, errors.New("could get 'logic_category' because the object could not be cast to *categorylogic.Impl")
	}
	return o, nil
}
...
//
// If the object can not be retrieved, it panics.
func (c *Container) GetLogicCategory() *categorylogic.Impl {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it returns an error.
func (c *Container) UnscopedSafeGetLogicCategory() (*categorylogic.Impl, error) {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it panics.
func (c *Container) UnscopedGetLogicCategory() *categorylogic.Impl {
...
// If the container can not be retrieved, it panics.
func LogicCategory(i interface{}) *categorylogic.Impl {
...
//		- "3": Service(*mysqltxhandler.MySQLTxHandler) ["tx_handler"]
//	unshared: false
//	close: false
//
// ---------------------------------------------
//
// If the object can not be retrieved, it returns an error.
func (c *Container) SafeGetPersistenceMysql() (*mysqlstore.Store, error) {
	i, err := c.ctn.SafeGet("persistence_mysql")
	if err != nil {
		var eo *mysqlstore.Store
		return eo, err
	}
	o, ok := i.(*mysqlstore.Store)
	if !ok {
		return o, errors.New("could get 'persistence_mysql' because the object could not be cast to *mysqlstore.Store")
	}
	return o, nil
}
...
//
// If the object can not be retrieved, it panics.
func (c *Container) GetPersistenceMysql() *mysqlstore.Store {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it returns an error.
func (c *Container) UnscopedSafeGetPersistenceMysql() (*mysqlstore.Store, error) {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it panics.
func (c *Container) UnscopedGetPersistenceMysql() *mysqlstore.Store {
...
// If the container can not be retrieved, it panics.
func PersistenceMysql(i interface{}) *mysqlstore.Store {
...
//
//	name: "tx_handler"
//	type: *mysqltxhandler.MySQLTxHandler
//	scope: "main"
//	build: func
//	params:
...
//
// If the object can not be retrieved, it returns an error.
func (c *Container) SafeGetTxHandler() (*mysqltxhandler.MySQLTxHandler, error) {
	i, err := c.ctn.SafeGet("tx_handler")
	if err != nil {
		var eo *mysqltxhandler.MySQLTxHandler
		return eo, err
	}
	o, ok := i.(*mysqltxhandler.MySQLTxHandler)
	if !ok {
		return o, errors.New("could get 'tx_handler' because the object could not be cast to *mysqltxhandler.MySQLTxHandler")
	}
	return o, nil
}
...
//
// If the object can not be retrieved, it panics.
func (c *Container) GetTxHandler() *mysqltxhandler.MySQLTxHandler {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it returns an error.
func (c *Container) UnscopedSafeGetTxHandler() (*mysqltxhandler.MySQLTxHandler, error) {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it panics.
func (c *Container) UnscopedGetTxHandler() *mysqltxhandler.MySQLTxHandler {
...
// If the container can not be retrieved, it panics.
func TxHandler(i interface{}) *mysqltxhandler.MySQLTxHandler {
...
//
//	name: "tx_provider"
//	type: *mysqltxprovider.Impl
//	scope: "main"
//	build: func
//	params:
//		- "0": Service(*logrus.Entry) ["logger_logrus"]
//		- "1": Service(*sqlx.DB) ["db_mysql"]
//		- "2": Service(*mysqltxhandler.MySQLTxHandler) ["tx_handler"]
//	unshared: false
//	close: false
//
// ---------------------------------------------
//
// If the object can not be retrieved, it returns an error.
func (c *Container) SafeGetTxProvider() (*mysqltxprovider.Impl, error) {
	i, err := c.ctn.SafeGet("tx_provider")
	if err != nil {
		var eo *mysqltxprovider.Impl
		return eo, err
	}
	o, ok := i.(*mysqltxprovider.Impl)
	if !ok {
		return o, errors.New("could get 'tx_provider' because the object could not be cast to *mysqltxprovider.Impl")
	}
	return o, nil
}
...
//
// If the object can not be retrieved, it panics.
func (c *Container) GetTxProvider() *mysqltxprovider.Impl {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it returns an error.
func (c *Container) UnscopedSafeGetTxProvider() (*mysqltxprovider.Impl, error) {
...
// This method can be called even if main is a sub-scope of the container.
// If the object can not be retrieved, it panics.
func (c *Container) UnscopedGetTxProvider() *mysqltxprovider.Impl {
...
// If the container can not be retrieved, it panics.
func TxProvider(i interface{}) *mysqltxprovider.Impl {
