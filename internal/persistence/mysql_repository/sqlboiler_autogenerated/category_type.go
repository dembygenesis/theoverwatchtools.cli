...
func (q categoryTypeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*CategoryType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: failed to execute a one query for category_type")
	}
...
func (q categoryTypeQuery) All(ctx context.Context, exec boil.ContextExecutor) (CategoryTypeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: failed to assign all query results to CategoryType slice")
	}
...
func (q categoryTypeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to count category_type rows")
	}
...
func (q categoryTypeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler_autogenerated: failed to check if category_type exists")
	}
...
func FindCategoryType(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*CategoryType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: unable to select from category_type")
	}
...
func (o *CategoryType) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler_autogenerated: no category_type provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to insert into category_type")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to populate default values for category_type")
	}
...
func (o *CategoryType) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler_autogenerated: unable to update category_type, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update category_type row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by update for category_type")
	}
...
func (q categoryTypeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update all for category_type")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve rows affected for category_type")
	}
...
func (o CategoryTypeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update all in categoryType slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve rows affected all in update all categoryType")
	}
	return rowsAff, nil
}
...
func (o *CategoryType) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler_autogenerated: no category_type provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("sqlboiler_autogenerated: unable to upsert category_type, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to upsert for category_type")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve unique values for category_type")
	}
...
func (o *CategoryType) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboiler_autogenerated: no CategoryType provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete from category_type")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by delete for category_type")
	}
...
func (q categoryTypeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboiler_autogenerated: no categoryTypeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete all from category_type")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by deleteall for category_type")
	}
...
func (o CategoryTypeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete all from categoryType slice")
	}
...
func (o *CategoryTypeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to reload all in CategoryTypeSlice")
	}
...
func CategoryTypeExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler_autogenerated: unable to check if category_type exists")
	}
