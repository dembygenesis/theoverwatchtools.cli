...
var CategoryWhere = struct {
	...
	IsActive:          whereHelpernull_Int{field: "`category`.`is_active`"},
...
func (q categoryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Category, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: failed to execute a one query for category")
	}
...
func (q categoryQuery) All(ctx context.Context, exec boil.ContextExecutor) (CategorySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: failed to assign all query results to Category slice")
	}
...
func (q categoryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to count category rows")
	}
...
func (q categoryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler_autogenerated: failed to check if category exists")
	}
...
func FindCategory(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Category, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "sqlboiler_autogenerated: unable to select from category")
	}
...
func (o *Category) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler_autogenerated: no category provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to insert into category")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to populate default values for category")
	}
...
func (o *Category) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("sqlboiler_autogenerated: unable to update category, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update category row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by update for category")
	}
...
func (q categoryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update all for category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve rows affected for category")
	}
...
func (o CategorySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to update all in category slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve rows affected all in update all category")
	}
	return rowsAff, nil
}
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("sqlboiler_autogenerated: no category provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("sqlboiler_autogenerated: unable to upsert category, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to upsert for category")
	}
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to retrieve unique values for category")
	}
...
func (o *Category) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("sqlboiler_autogenerated: no Category provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete from category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by delete for category")
	}
...
func (q categoryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("sqlboiler_autogenerated: no categoryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete all from category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: failed to get rows affected by deleteall for category")
	}
...
func (o CategorySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "sqlboiler_autogenerated: unable to delete all from category slice")
	}
...
func (o *CategorySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "sqlboiler_autogenerated: unable to reload all in CategorySlice")
	}
...
func CategoryExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "sqlboiler_autogenerated: unable to check if category exists")
	}
