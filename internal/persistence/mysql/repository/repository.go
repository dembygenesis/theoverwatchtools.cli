...
type Categories interface {
	GetCategories(ctx context.Context, t Transaction, f *models.CategoryFilter) (models.Categories, error)
	UpsertCategories(ctx context.Context, t Transaction, categories []models.Category) (models.Categories, error)
}
