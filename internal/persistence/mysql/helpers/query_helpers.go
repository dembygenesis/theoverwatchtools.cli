...
func preparePagination(ctx context.Context, db *sqlx.DB, query string, pagination *models.Pagination, args ...interface{}) (string, error) {
...
func queryAsStringArrays(ctx context.Context, db *sqlx.DB, query string, pagination *models.Pagination) ([][]string, error) {
