...
import (
	"context"
	"fmt"
	"github.com/dembygenesis/local.tools/internal/lib/docker_env"
...
func NewMariaDB(cfg *MariaDBConfig) (*docker_env.DockerEnv, error) {
	...
	dm, err := docker_env.New(&docker_env.ContainerConfig{
