...
func (fake *FakeCategoryService) GetCategories(arg1 context.Context, arg2 *model.CategoryFilters) (*model.PaginatedCategories, error) {
...
func (fake *FakeCategoryService) GetCategoriesCalls(stub func(context.Context, *model.CategoryFilters) (*model.PaginatedCategories, error)) {
	fake.getCategoriesMutex.Lock()
	defer fake.getCategoriesMutex.Unlock()
	fake.GetCategoriesStub = stub
}

func (fake *FakeCategoryService) GetCategoriesArgsForCall(i int) (context.Context, *model.CategoryFilters) {
	fake.getCategoriesMutex.RLock()
	defer fake.getCategoriesMutex.RUnlock()
...
func (fake *FakeCategoryService) GetCategoriesReturns(result1 *model.PaginatedCategories, result2 error) {
	fake.getCategoriesMutex.Lock()
	defer fake.getCategoriesMutex.Unlock()
...
func (fake *FakeCategoryService) GetCategoriesReturnsOnCall(i int, result1 *model.PaginatedCategories, result2 error) {
	fake.getCategoriesMutex.Lock()
	defer fake.getCategoriesMutex.Unlock()
	fake.GetCategoriesStub = nil
